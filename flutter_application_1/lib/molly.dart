...
class MollyProfile extends StatelessWidget {
  const MollyProfile({super.key});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            _buildStatCard('3 Years', 'Age', primaryPink),
                            _buildStatCard('Female', 'Gender', primaryPink),
                            _buildStatCard('2 Weeks', 'Period', primaryPink),
                          ],
                        ),
                        const SizedBox(height: 25),
                        Text(
                        ...
                        const SizedBox(height: 10),
                        Text(
                          'Molly is a calm sweet dog, she is really caring. She only eats dry food and loves cuddles.',
                          style: GoogleFonts.plusJakartaSans(
                            color: textGrey,
                            fontSize: 14,
                            height: 1.6,
                              ...
                              onTap: () => Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) => const ChatScreen(
                                    recipientName: 'molly',
                                    recipientImage: 'assets/images/molly.png',
                                  ),
                                ),
                              ),
                              child: Container(
